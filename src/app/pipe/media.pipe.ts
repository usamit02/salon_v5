...
export class MediaPipe implements PipeTransform {
  ...
  transform(value: any, type: string): string {
    switch (type) {
      case 'img': return 'https://firebasestorage.googleapis.com/v0/b/' + firebaseConfig.storageBucket + '/o/'
        + encodeURIComponent("room/" + this.data.room.id + "/" + value) + '?alt=media';
      case 'imgorg': return 'https://firebasestorage.googleapis.com/v0/b/' + firebaseConfig.storageBucket + '/o/'
